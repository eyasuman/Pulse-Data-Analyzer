    ...
    >
      ...
      <View style={styles.statsGrid}>
        <View style={styles.row}>
          <StatCard label="Active Providers" value={stats.active} color="#10b981" trend="up" trendValue={`${stats.total} total`} />
          <StatCard label="Pending Review" value={stats.pending} color="#f59e0b" />
        </View>
        <View style={styles.row}>
          <StatCard label="Completed Appts" value={stats.completed} color="#818cf8" />
          <StatCard label="Platform Revenue" value={`AED ${stats.platformRevenue.toLocaleString()}`} color="#6366f1" />
        </View>
      </View>
