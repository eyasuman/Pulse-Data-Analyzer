        ...
        >
          <Text
            style={[
              styles.trendText,
              {
                color: trend === "up" ? "#10b981" : trend === "down" ? "#ef4444" : colors.mutedForeground,
              },
            ]}
          >
...
const styles = StyleSheet.create({
  card: {
    ...
    gap: 4, minHeight: 110, justifyContent: "flex-end",
  },
  dot: {
  ...
  value: { fontSize: 26, fontWeight: "700", letterSpacing: -0.5, fontFamily: "Inter_700Bold" },
  label: {
    fontSize: 11, fontWeight: "600", letterSpacing: 0.5,
    textTransform: "uppercase", opacity: 0.6, fontFamily: "Inter_600SemiBold",
  },
  subLabel: { fontSize: 10, marginTop: 2, fontFamily: "Inter_400Regular" },
  trend: {
    marginTop: 6, paddingHorizontal: 7, paddingVertical: 3,
    borderRadius: 6, borderWidth: 1, alignSelf: "flex-start",
  },
  trendText: { fontSize: 9, fontWeight: "700", fontFamily: "Inter_700Bold", letterSpacing: 0.5 },
});
