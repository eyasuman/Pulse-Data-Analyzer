    ...
    <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={[styles.id, { color: colors.mutedForeground }]}>
            #{appointment.id.split("_")[1] ?? appointment.id.slice(-6)}
          </Text>
        </View>
      ...
      <View style={styles.parties}>
        <View style={styles.party}>
          ...
          <View>
            ...
            <Text style={[styles.partyName, { color: colors.foreground }]}>{appointment.doctorName}</Text>
          </View>
        </View>
        ...
        <View style={styles.party}>
          ...
          <View>
            ...
            <Text style={[styles.partyName, { color: colors.foreground }]}>{appointment.patientName}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.footer, { borderTopColor: colors.border }]}>
        <View style={styles.footerItem}>
          ...
          <Text style={[styles.footerText, { color: colors.mutedForeground }]}>{appointment.serviceType}</Text>
        </View>
        <View style={styles.footerItem}>
          <Feather name="calendar" size={11} color={colors.mutedForeground} />
          <Text style={[styles.footerText, { color: colors.mutedForeground }]}>{dateStr} at {timeStr}</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  id: { fontSize: 10, fontWeight: "500", letterSpacing: 0.5, fontFamily: "Inter_500Medium" },
  ...
  partyRole: { fontSize: 9, fontWeight: "500", textTransform: "uppercase", letterSpacing: 0.5, fontFamily: "Inter_500Medium" },
  partyName: { fontSize: 13, fontWeight: "600", fontFamily: "Inter_600SemiBold" },
  ...
  feeBreakdown: { borderRadius: 7, borderWidth: 1, paddingHorizontal: 8, paddingVertical: 4 },
  feeText: { fontSize: 10, fontFamily: "Inter_400Regular" },
});
